        ...
        <div id="header-top">
          <video autoplay loop muted class="video" >
           ...
           <nav  class="header" id="myHeader" >
            <a href=""><img src="upload/1.png" alt="" class="logo"></a>
            <ul>
           ...
           require_once('sanpham.php');
            ...
            <form action="" method="GET" style="text-align: center;">
                  ...
                  <?php 
                    ...
                    ?>
       <ul id="autoWidth" class="cs-hidden"> <?php while($tungloaisp=mysqli_fetch_array($rs)){ ?>
          <li class="item-a">
                ...
                <p><?php echo $tungloaisp['gia'] ?></p>
                  <?php if(empty($_SESSION['id'])){ ?> 
                   ...
                   <?php } else{ ?> 
                      ...
                      <!-- <a href="showsp.php?id=" data-toggle="modal" data-target="#myModal" >Mua</a> -->
                      ...
                      <a href="" name="addcart" data-toggle="modal" data-target="#myModal">Mua</a> 
